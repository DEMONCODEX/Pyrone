...
ONE_WORDS = ["𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙆𝙄", "𝘾𝙃𝙐𝙏", "𝘼𝙅𝘼", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙆𝙄", "𝘾𝙃𝙐𝙏", "𝙁𝘼𝘼𝘿", "𝘿𝙐𝙉𝙂𝘼", "𝙃𝙄𝙅𝘿𝙀", "𝙏𝙀𝙍𝘼", "𝘽𝘼𝘼𝙋",
           ...
           "𝘼𝙐𝙆𝘼𝙏 𝙈𝙀", "𝙍𝘼𝙃𝙊", "𝙒𝘼𝙍𝙉𝘼", "𝙈𝘼𝘼 𝘾𝙃𝙊𝘿 𝘿𝙀𝙉𝙂𝙀 𝙏𝙐𝙈𝘼𝙍𝙄", "𝙋𝙃𝙄𝙍", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝘾𝙃𝙊𝘿𝙉𝙀", "𝘼𝙔𝘼", "𝘽𝘼𝙇𝘼𝙆", "𝘽𝙃𝙀𝙉", "𝙆𝙀", "𝙇𝙊𝘿𝙀𝙀", "𝙏𝙀𝙍𝙄", 
"𝙈𝘼𝙄𝙔𝘼", "𝙆𝙊", "𝙋𝘼𝙏𝘼𝙆", "𝙆𝙀", "𝘾𝙃𝙊𝘿𝙐", "𝙍𝘼𝙉𝘿𝙄𝙎", "𝘽𝘼𝘼𝙋", "𝙎𝙀", "𝙇𝘼𝘿𝙀𝙉𝙂𝘼", "𝘽𝙃𝙀𝙉", "𝙆𝙀", "𝙇𝙊𝘿𝙀𝙀", "𝙏𝙀𝙍𝙄", "𝙂𝘼𝙉𝘿", "𝙈𝙀",
"𝙋𝙀𝙏𝙍𝙊𝙇", "𝘿𝘼𝙇𝙆𝙀𝙀", "𝘼𝘼𝙂", "𝙇𝘼𝙂𝘼", "𝘿𝙐𝙉𝙂𝘼", "𝙍𝘼𝙉𝘿𝙄𝙊", "𝙆𝙀", "𝘽𝘼𝘾𝙃𝙀", "𝘽𝙃𝙀𝙉", "𝙆𝙀", "𝙇𝙊𝘿𝙀", "𝙏𝙊𝙃𝙍𝙄𝙄", "𝘿𝘼𝙄𝙄", "𝙆𝘼", "𝘾𝙃𝙊𝘿𝘼",
"𝘽𝘼𝙇𝘼𝙆", "𝙎𝙋𝙀𝘿𝘿", "𝙋𝘼𝙆𝘿", "𝙇𝙀", "𝙍𝘼𝙉𝘿𝙄", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝙄𝙔𝘼𝘼", "𝙆𝘼", "𝘾𝙃𝙊𝘿𝙊", "𝘽𝙃𝙀𝙉", "𝙆𝘼", "𝘽𝙃𝙊𝙎𝘿𝘼", "𝙁𝘼𝘿𝙐", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", 
"𝙆𝘼𝘼", "𝙉𝙐𝘿𝙀𝙎", "𝙑𝙄𝙍𝘼𝙇", "𝙆𝘼𝙍𝘿𝙐𝙉𝙂𝘼", "𝙆𝙊𝙏𝙃𝘼", "𝙈𝙀", "𝙁𝙍𝙀𝙀", "𝙈𝙀", "𝘾𝙃𝙐𝘿𝙑𝘼𝙏𝙄", "𝙃𝘼𝙄", "𝙑𝙊", "𝙍𝘼𝙉𝘿𝙄", "𝙆𝙄", "𝘽𝘼𝘾𝙃𝙄", "𝘽𝙃𝙀𝙉",
"𝙏𝙀𝙍𝙄", "𝙈𝘼𝙄𝙄", "𝙆𝘼", "𝘾𝙃𝙐𝙏", "𝘽𝙊𝙇𝘼", "𝙍𝘼𝙉𝘿𝙄", "𝘾𝙃𝙄𝙉𝘼𝙇", "𝙆𝙀", "𝘼𝙐𝙇𝘼𝘿", "𝙏𝙀𝙍𝘼", "𝘽𝘼𝘼𝙋", "𝙆𝙀", "𝙂𝘼𝙉𝘿", "𝙈𝙀", "𝙎𝘼𝙍𝙄𝙔𝘼",
"𝘿𝘼𝙇𝙇", "𝙆𝙀", "𝘽𝘼𝙍𝘽𝙄𝙌𝙐𝙀", "𝘽𝘼𝙉𝘼", "𝘿𝙐𝙉𝙂𝘼", "𝙊𝙍", "𝘽𝙄𝘾𝙃", "𝘾𝙃𝙊𝙃𝙍𝘼𝙔𝙀", "𝙋𝙀", "𝘿𝘼𝙇", "𝘿𝙐𝙉𝙂𝘼", "𝙏𝙀𝙍𝙄", "𝙈𝙐𝙈𝙈𝙔", "𝙆𝙄", "𝙋𝙐𝙎𝙎𝙔", 
"𝙈𝙀", "𝘼𝙋𝙉𝘼", "𝙇𝙊𝘿𝘼", "𝘿𝘼𝙇𝙇", "𝘿𝙐𝙉𝙂𝘼", "𝘽𝙃𝙀𝙉", "𝙆𝙀", "𝙇𝙊𝘿𝙀", "𝙏𝙀𝙍𝙄𝙄", "𝙈𝘼𝘼", "𝘾𝙃𝙊𝘿", "𝘿𝙄𝘼", "𝘼𝘽", "𝘽𝙊𝙇", "𝙉𝘼",
"𝘽𝙃𝙀𝙉", "𝙆𝙀", "𝙇𝙊𝘿𝙀", "𝙆𝘼𝙇𝘼𝙋", "𝙆𝙀", "𝙁𝘼𝙍𝙍𝙍𝙍", "𝙃𝙊𝙂𝙔𝘼", "𝙍𝘼𝙉𝘿𝙄", "𝙆𝙀", "𝘽𝘼𝘾𝙃𝙀𝙀𝙀", "𝙈𝘼𝘿𝘼𝙃𝙍𝘾𝙃𝙊𝘿 𝙆 𝙋𝙄𝙇𝙇𝙀", "𝘽𝙀𝙃𝙀𝙉𝘾𝙃𝙊𝘿", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙆𝙄",
"𝘾𝙃𝙊𝙊𝙏", "𝙈𝙀", "𝙋𝙃𝘼𝙑𝘿𝘼", "𝘿𝘼𝙇𝘿𝙐𝙉𝙂𝘼", "𝙇𝙊𝙇", "𝙂𝘼𝙉𝘿", "𝙆𝙀", "𝙆𝙄𝘿𝘼", "𝙕𝙔𝘼𝘿𝘼", "𝙆𝙃𝙐𝙅𝘼", "𝙈𝘼𝙏", "𝙑𝙈𝙍𝙊", "𝙏𝙀𝙍𝙄", "𝘿𝘼𝙄𝙄", "𝘾𝙃𝙐𝘿", 
"𝙂𝙔𝙄", "𝙐𝙁𝙁𝙁", "𝙇𝙊𝘿𝙀", "𝙆𝙀", "𝘽𝘼𝘼𝙇", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙆𝘼", "𝘽𝙃𝙊𝙎𝘿𝘼", "𝙈𝘼𝙍𝙐", "𝘿𝘼𝙇𝙇𝙀", "𝙏𝙀𝙍𝙄", "𝙂𝘼𝙉𝘿", "𝙈𝘼𝙍𝙍𝘿𝙐𝙉𝙂𝘼", "𝙍𝘼𝙉𝘿𝙄𝙄",
"𝙎𝙐𝘼𝙍", "𝙆𝙀", "𝙋𝙄𝙇𝙇𝙀", "𝘼𝙐𝙆𝘼𝙏𝙏", "𝙈𝙀", "𝙍𝘼𝙃𝙃", "𝙇𝙀", "𝙑𝘼𝙍𝙉𝘼", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝙍𝙊𝙕𝙕", "𝘾𝙃𝙊𝘿", "𝘿𝙐𝙉𝙂𝘼", "𝙍𝘼𝙉𝘿𝙄𝙄", "𝙆𝙀",
"𝘽𝘼𝘾𝙃𝙀", "𝘼𝘼𝘼", "𝘽𝙀𝙏𝘼", "𝙎𝙋𝙀𝙀𝘿", "𝙋𝘼𝙆𝘿", "𝘽𝙃𝙀𝙉", "𝙆𝙀", "𝙇𝙊𝘿𝙀", "𝙏𝙀𝙍𝙄", "𝘼𝙈𝙄𝙄", "𝙆𝘼𝘼𝘼", "𝘽𝙐𝙍𝙍𝙍", "𝙁𝘼𝘿𝙐𝙐", "𝙏𝙀𝙍𝙄", "𝘽𝙃𝙀𝙉", 
"𝙆𝘼", "𝘽𝙃𝙊𝙎𝘿𝘼", "𝙈𝘼𝙍𝙐", "𝙍𝘼𝙉𝘿𝙄", "𝘾𝙃𝙄𝙉𝘼𝙇", "𝙆𝙀", "𝘽𝘼𝘾𝙃𝙀", "𝘼𝘽", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼", "𝘾𝙃𝙐𝘿𝙀𝙂𝙄", "𝙆𝙐𝙏𝙏𝙀", "𝙆𝙄", "𝙏𝘼𝙍𝙃𝘼", "𝙂𝘼𝙉𝘿",
"𝙈𝘼𝙍𝙐𝙉𝙂𝘼", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼𝘼", "𝙆𝘼", "𝘾𝙃𝙐𝙏", "𝙇𝘼𝘼𝙇", "𝙆𝘼𝙍𝘿𝙐𝙉𝙂", "𝘾𝙃𝙊𝘿", "𝙆𝙀", "𝘽𝙃𝙀𝙉", "𝙆𝙀", "𝙇𝙊𝘿𝙀", "𝙏𝙀𝙍𝙄", "𝘿𝘼𝙄𝙄", "𝙆𝙊",
"𝙈𝘼", "𝘼𝙋𝙉𝙄", "𝙍𝘼𝙉𝘿𝙄", "𝘽𝘼𝙉𝘼𝙐𝙉𝙂𝘼", "𝘽𝙃𝙀𝙉", "𝙆𝙀", "𝙇𝙊𝘿𝙀", "𝘽𝙃𝘼𝙂𝘼", "𝙏𝙊", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝘼𝘼", "𝙊𝙍", "𝙂𝘼𝙉𝘿𝙀", "𝙎𝙀", "𝘾𝙃𝙊𝘿𝙐𝙉𝙂𝘼", 
"𝙍𝘼𝙉𝘿𝙄", "𝙏𝙊𝙃𝙍𝙄𝙄", "𝘽𝙃𝙀𝙉", "𝙆𝙄", "𝘾𝙃𝙊𝙊𝙏", "𝙊𝙋", "𝘿𝘼𝙇𝙇𝙀", "𝙂𝘼𝙉𝘿", "𝙆𝙀", "𝙏𝙀𝙍𝙄", "𝘽𝙃𝙀𝙉", "𝙆𝙊𝙏𝙃𝘼", "𝙈𝙀", "𝙂𝘼𝙉𝘿", "𝘿𝙀𝙏𝙄",
"𝙑𝙊", "𝘽𝙃𝙄", "𝙁𝙍𝙀𝙀", "𝙈𝙀", "𝘽𝙃𝙊𝙎𝘿𝙄𝙆𝙀", "𝙏𝙀𝙍𝙄", "𝙈𝘼𝙄𝙔𝘼", "𝙆𝘼", "𝘾𝙃𝙐𝙏", "𝙇𝘼𝘼𝙇𝙈𝙇𝘼𝘼𝙇", "𝘽𝙃𝙊𝙎𝘿𝘼", "𝙈𝘼𝙍𝙐", "𝙇𝘼𝙑𝘿𝙀", "𝙆𝙀 𝘽𝘼𝘼𝙇", "𝙁𝘼𝙍𝙍𝙍𝙍𝙍𝙍𝙍𝙍𝙍𝙍𝙍𝙍𝙍𝙍 𝙃𝙊𝙂𝙔𝘼𝘼𝘼𝘼𝘼𝘼𝘼𝘼𝘼𝘼𝘼𝘼"] 
...
if M1:
    M1.add_handler(MessageHandler(pyrone, filters.command(["T3RI", "L0L", "AJA", "AAJA", "START", "𝘼𝙅𝘼"], prefixes=None) & filters.me))
    M1.add_handler(MessageHandler(restart, filters.command(["XD", "FARAR", "STOP", "FUCKED"], prefixes=None) & filters.me))

if M2:
    M2.add_handler(MessageHandler(pyrone, filters.command(["T3RI", "L0L", "AJA", "AAJA", "START", "𝘼𝙅𝘼"], prefixes=None) & filters.me))
    M2.add_handler(MessageHandler(restart, filters.command(["XD", "FARAR", "STOP", "FUCKED"], prefixes=None) & filters.me))

if M3:
    M3.add_handler(MessageHandler(pyrone, filters.command(["T3RI", "L0L", "AJA", "AAJA", "START", "𝘼𝙅𝘼"], prefixes=None) & filters.me))
    M3.add_handler(MessageHandler(restart, filters.command(["XD", "FARAR", "STOP", "FUCKED"], prefixes=None) & filters.me))

if M4:
    M4.add_handler(MessageHandler(pyrone, filters.command(["T3RI", "L0L", "AJA", "AAJA", "START", "𝘼𝙅𝘼"], prefixes=None) & filters.me))
    M4.add_handler(MessageHandler(restart, filters.command(["XD", "FARAR", "STOP", "FUCKED"], prefixes=None) & filters.me))

if M5:
    M5.add_handler(MessageHandler(pyrone, filters.command(["T3RI", "L0L", "AJA", "AAJA", "START", "𝘼𝙅𝘼"], prefixes=None) & filters.me))
